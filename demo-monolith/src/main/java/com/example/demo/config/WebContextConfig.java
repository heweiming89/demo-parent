...
//		}
		...
		final String portalPattern = "/**";
		final String portalLocations = "classpath:/META-INF/resources/portal/1.0.0/";
		if (!registry.hasMappingForPattern(portalPattern)) {
			registry.addResourceHandler(portalPattern).addResourceLocations(portalLocations);
		}

		final String consolePattern = "/admin/**";
		final String consoleLocations = "classpath:/META-INF/resources/console/1.0.0/";
		if (!registry.hasMappingForPattern(consolePattern)) {
			registry.addResourceHandler(consolePattern).addResourceLocations(consoleLocations);
		}
